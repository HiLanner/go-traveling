...
<body>
	...
	<div class="img-content">
		...
		<div class="search tip-search">
			...
			<div class="clear"></div>
			<input name="text" type="text" value="请输入特产" />&nbsp;&nbsp;<input name="search" type="button" value="搜索" />
		</div>
	</div>
				...
				while($sqlSpecialtyResult = mysqli_fetch_array($sqlSpecialtyQuery)) {
					...
					<li>
						...
						<div class="items-intro">
							<span><?php echo $sqlSpecialtyResult[describtion] ?><a href="buyhotel.php?h_id=<?php echo $sqlSpecialtyResult['id']?>">购买</a></span>
						</div>
					</li>
					<?php
				}
